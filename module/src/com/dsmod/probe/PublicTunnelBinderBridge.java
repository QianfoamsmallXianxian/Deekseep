...
final class PublicTunnelBinderBridge {
    ...
    static final int TRANSACTION_CANCEL_PROVISIONING = IBinder.FIRST_CALL_TRANSACTION + 5;
    ...
    private static final class Bridge extends Binder {
        @Override protected boolean onTransact(int code, Parcel data, Parcel reply, int flags)
            ...
            if (code != TRANSACTION_STATUS && code != TRANSACTION_CONFIGURE
                    ...
                    && code != TRANSACTION_CANCEL_PROVISIONING) {
            ...
            } else if (code == TRANSACTION_CANCEL_PROVISIONING) {
